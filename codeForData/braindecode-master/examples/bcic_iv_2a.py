...
def run_exp(data_folder, subject_id, low_cut_hz, model, cuda):
    ...
    if saveFlag:
        ...
        sio.savemat(str(subject_id)+'.mat', {'trnData': train_set.X, 'trnLabel':train_set.y, 'tstData': test_set.X, 'tstLabel': test_set.y})
    else:
...
if __name__ == "__main__":
    ...
    data_folder = "/home/keyzhao/pythonScript/braindecode-master/data/BCICIV_2a_gdf/"
